...
public class SDLActivity extends Activity {
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if (hasFocus) {
            SDLActivity.mSurface.setSystemUiVisibility(
    ...
    public static void handlePause() {
        if (!SDLActivity.mIsPaused && SDLActivity.mIsSurfaceReady) {
            ...
            com.angelde.fnadroid.FNADroidWrapper.hookedEnableAdditionalSensors(mSurface, false);
        }
    }
    ...
    public static void handleResume() {
        if (SDLActivity.mIsPaused && SDLActivity.mIsSurfaceReady && SDLActivity.mHasFocus) {
            ...
            com.angelde.fnadroid.FNADroidWrapper.hookedEnableAdditionalSensors(mSurface, true);
        }
    }
